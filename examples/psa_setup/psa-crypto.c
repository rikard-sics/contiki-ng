...
void init_psa_crypto() {
  ...
  //temp set PSA key
  /*
  memset(&psa_key_material[0], 11, 16);
  memset(&psa_key_material[16], 22, 16);
  memset(&psa_key_material[32], 33, 16);
  memset(&psa_key_material[48], 44, 16);
  memset(&psa_key_material[64], 55, 16);
  memset(&psa_key_material[80], 66, 16);
  memset(&psa_key_material[96], 77, 16);
  memset(&psa_key_material[112], 88, 16);
  memset(&psa_key_material[128], 99, 16);
  memset(&psa_key_material[144], 0, 16);
  */
}
